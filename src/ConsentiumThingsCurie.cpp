#include <ConsentiumThingsCurie.h>
...
ConsentiumThingsCurie::ConsentiumThingsCurie(){}

void ConsentiumThingsCurie::begin(){
...
void ConsentiumThingsCurie::initWiFi(const char* ssid, const char* password){
...
float ConsentiumThingsCurie::busRead(int j, float threshold){
...
void ConsentiumThingsCurie::sendREST(const char* key, int sensor_num, String info[],  float data[], int pre, long delay_interval_s){ 
